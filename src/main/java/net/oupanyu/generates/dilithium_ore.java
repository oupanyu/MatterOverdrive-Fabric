  ...
  public static void gen_dilithium()
    {
      ...
      Registry.register(Registry.ITEM, new Identifier("matteroverdrive", "dilithium_ore"), new BlockItem(dilithium_ore, new Item.Settings().group(iteminit.BLOCK_AND_ITEMS)));
