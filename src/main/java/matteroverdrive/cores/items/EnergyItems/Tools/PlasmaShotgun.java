...
public class PlasmaShotgun extends BatteryItemWithToolTip {

    public PlasmaShotgun(long capacity, long maxInput, long maxOutput) {
        super(capacity, maxInput, maxOutput);
    }

    @Override
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        System.out.println("PlasmaShotgun");
